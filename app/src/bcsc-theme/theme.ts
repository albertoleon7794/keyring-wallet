...
import { KeyRingTheme, GrayscaleColors, NotificationColors } from '@keyring-theme/theme'
...
export const BCSCColorPalette: IColorPalette = {
  ...KeyRingTheme.ColorPalette,
  notification: BCSCNotificationColors,
  brand: {
    ...KeyRingTheme.ColorPalette.brand,
    primary: '#FCBA19',
  ...
  semantic: {
    ...KeyRingTheme.ColorPalette.semantic,
    success: '#89CE00',
  },
}

export const BCSCTheme = new ThemeBuilder(KeyRingTheme)
  .setColorPalette(BCSCColorPalette)
  .withOverrides({
    themeName: KeyRingThemeNames.BCSC,
  })
  // TextTheme overrides
  .withOverrides(
